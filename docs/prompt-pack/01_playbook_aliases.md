...
## Direct Playbook Calls

### PBS Playbook
Use `10_pbs_playbook.md` when Gerry says things like:
...
### Report Playbook
Use `21_report_playbook.md` when Gerry says things like:
...
### Protection Playbook
Use `22_protection_playbook.md` when Gerry says things like:
