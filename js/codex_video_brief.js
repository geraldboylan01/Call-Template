...
export function buildCodexVideoBrief({
  ...
  return {
    ...
    delivery: {
      ...
      outputDirectory,
      requiredFiles: ['index.html', 'storyboard.md', 'source-brief.json'],
