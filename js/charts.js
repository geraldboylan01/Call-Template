...
function buildChartConfig(chartData, { module } = {}) {
  ...
  const isPensionChart = pensionModule || accumulationByTitleOrLabels || sustainabilityByTitleOrLabels;
  const showMax = isPensionChart ? getPensionShowMax(module?.id) : false;
