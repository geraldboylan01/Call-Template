...
export const HIDDEN_PATHS = Object.freeze({
  ...
  '/scenarios': 'Server-managed comparison cases: approved college costs, or the repayment options being compared. Never ask a client to invent either.',
  '/overpaymentBenefit': 'Semantic: whether a capital reduction shortens the term or lowers the repayment. The lender asks this; it is recorded as a stated choice.',
  '/baseScenarioId': 'Engine bookkeeping: which case the others are measured against.',
