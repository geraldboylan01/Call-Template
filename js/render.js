...
export function getUiElements() {
  return {
    ...
    mobileOverflowConsumerPlannerTestButton: document.getElementById('mobileOverflowConsumerPlannerTestBtn'),
    ...
    consumerPlannerTestButton: document.getElementById('consumerPlannerTestBtn'),
