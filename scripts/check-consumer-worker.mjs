...
const realtimeDeploymentPolicy = {
  ...
  realtimePromptVersion: 'planeir-live-conversation-v14',
  realtimeToolsetVersion: 'planeir-live-tools-v2',
  livePromptVersion: 'planeir-live-conversation-v14',
  liveToolsetVersion: 'planeir-live-tools-v2',
