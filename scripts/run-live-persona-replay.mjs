...
const FACT_QUESTION_PATTERNS = Object.freeze({
  property_position: [
...
export function requestedFactIdsFromSpeech(text) {
  // Match every question independently. Including `?` as a boundary matters
  // for natural turns such as "Anything else? Do you own a home?". Spoken
  // requests can also be imperatives ("Tell me what your home is worth."),
  // so inspect those clauses too without treating an ordinary recap as an ask.
