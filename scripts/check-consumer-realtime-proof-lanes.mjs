...
assert.equal(live.promptVersion, 'planeir-live-conversation-v6');
...
assert.throws(
  ...
  /did not run the planeir-live-conversation-v6 prompt/
);
assert.throws(
...

{
  ...
  assert.match(bridgeSource, /planeir-live-conversation-v6/);
