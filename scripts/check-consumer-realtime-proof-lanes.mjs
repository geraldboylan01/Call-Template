...
assert.equal(live.promptVersion, 'planeir-live-conversation-v5');
...
assert.throws(
  ...
  /did not run the planeir-live-conversation-v5 prompt/
);
assert.throws(
...

{
  ...
  assert.match(bridgeSource, /planeir-live-conversation-v5/);
