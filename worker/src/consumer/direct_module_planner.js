    ...
    try {
      const repair = await extract({
        ...
        structuralSupportIssues: supportIssues.map((item) => ({
          moduleId: item.moduleId, paths: item.inputSupportIssues
        })),
