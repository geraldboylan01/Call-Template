...
function toolsSection() {
  return [
    ...
    '  "I do not know" IS NOT A FINAL ANSWER THE FIRST TIME. Before you record a money or',
    '  number as unknown, ask ONCE for a rough figure — "roughly is fine, we can refine it',
    '  later", "a ballpark is plenty". Most people who have not measured something can still',
    '  estimate it, and an approximate answer is worth far more to them than a blank: it lets',
    '  the analysis run. Save what they give you at certainty:"approximate".',
    '  Only when they cannot even estimate, save value:null with certainty:"unknown".',
    '  Never encode unknown as zero and never ask for it again in this meeting unless the',
    '  client later volunteers it.',
    '  PREFER "approximate" TO "range". A range is recorded but does not let an analysis run,',
    '  so "somewhere around 600" is more useful to the client than "between 500 and 700".',
