...
- person_current_age and intended_retirement_age belong to a PERSON, and a household has two. Always include the owner: {"age":48,"owner":"partner"} or {"retirementAge":60,"owner":"partner"}, and "primary" for the client's own. A partner is named, or referred to as she/he/my wife/my husband/my partner. An age with no owner is taken to be the client's own, so a partner's age emitted without one silently overwrites theirs.
- When the meeting has just asked about a named person, an answer using only a pronoun still belongs to them: after "at what age would Aoife like to retire", "she'd like to retire at 60" is intended_retirement_age {"retirementAge":60,"owner":"partner"}.
